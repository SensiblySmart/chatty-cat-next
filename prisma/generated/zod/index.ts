...
export const MessageScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','role','content','messageType','senderId','conversationId']);

export const ConversationScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','lastMessageAt','title','agentId','userId','isDeleted']);

export const AgentScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','displayName','description','avatarUrl','modelId','systemPromptId']);

export const ModelScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','provider','modelName']);

export const MemoryScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','userId','content']);
...
export const AgentSelectSchema: z.ZodType<Prisma.AgentSelect> = z.object({
  ...
  systemPromptId: z.boolean().optional(),
  conversations: z.union([z.boolean(),z.lazy(() => ConversationFindManyArgsSchema)]).optional(),
  model: z.union([z.boolean(),z.lazy(() => ModelArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => AgentCountOutputTypeArgsSchema)]).optional(),
}).strict()
...
export const ModelArgsSchema: z.ZodType<Prisma.ModelDefaultArgs> = z.object({
  select: z.lazy(() => ModelSelectSchema).optional(),
  include: z.lazy(() => ModelIncludeSchema).optional(),
}).strict();

export const ModelCountOutputTypeArgsSchema: z.ZodType<Prisma.ModelCountOutputTypeDefaultArgs> = z.object({
...
export const ConversationWhereInputSchema: z.ZodType<Prisma.ConversationWhereInput> = z.object({
  ...
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  lastMessageAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const ConversationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ConversationScalarWhereWithAggregatesInput> = z.object({
  ...
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  lastMessageAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const AgentWhereInputSchema: z.ZodType<Prisma.AgentWhereInput> = z.object({
  ...
  avatarUrl: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  modelId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  systemPromptId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  conversations: z.lazy(() => ConversationListRelationFilterSchema).optional(),
  model: z.union([ z.lazy(() => ModelScalarRelationFilterSchema),z.lazy(() => ModelWhereInputSchema) ]).optional(),
}).strict();
...
export const AgentOrderByWithRelationInputSchema: z.ZodType<Prisma.AgentOrderByWithRelationInput> = z.object({
  ...
  systemPromptId: z.lazy(() => SortOrderSchema).optional(),
  conversations: z.lazy(() => ConversationOrderByRelationAggregateInputSchema).optional(),
...
export const AgentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.AgentScalarWhereWithAggregatesInput> = z.object({
  ...
  avatarUrl: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  modelId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  systemPromptId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
}).strict();
...
export const ConversationUpdateInputSchema: z.ZodType<Prisma.ConversationUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lastMessageAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  agent: z.lazy(() => AgentUpdateOneRequiredWithoutConversationsNestedInputSchema).optional()
}).strict();
...
export const AgentCreateInputSchema: z.ZodType<Prisma.AgentCreateInput> = z.object({
  ...
  avatarUrl: z.string(),
  systemPromptId: z.string(),
  conversations: z.lazy(() => ConversationCreateNestedManyWithoutAgentInputSchema).optional(),
  model: z.lazy(() => ModelCreateNestedOneWithoutAgentsInputSchema)
}).strict();
...
export const AgentUncheckedCreateInputSchema: z.ZodType<Prisma.AgentUncheckedCreateInput> = z.object({
  ...
  modelId: z.string(),
  systemPromptId: z.string(),
  conversations: z.lazy(() => ConversationUncheckedCreateNestedManyWithoutAgentInputSchema).optional()
}).strict();
...
export const AgentUpdateInputSchema: z.ZodType<Prisma.AgentUpdateInput> = z.object({
  ...
  avatarUrl: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  systemPromptId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  conversations: z.lazy(() => ConversationUpdateManyWithoutAgentNestedInputSchema).optional(),
  model: z.lazy(() => ModelUpdateOneRequiredWithoutAgentsNestedInputSchema).optional()
}).strict();
...
export const AgentUncheckedUpdateInputSchema: z.ZodType<Prisma.AgentUncheckedUpdateInput> = z.object({
  ...
  systemPromptId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  conversations: z.lazy(() => ConversationUncheckedUpdateManyWithoutAgentNestedInputSchema).optional()
}).strict();
...
export const ModelCreateInputSchema: z.ZodType<Prisma.ModelCreateInput> = z.object({
  ...
  provider: z.string(),
  modelName: z.string(),
  agents: z.lazy(() => AgentCreateNestedManyWithoutModelInputSchema).optional()
}).strict();
...
export const ModelUncheckedCreateInputSchema: z.ZodType<Prisma.ModelUncheckedCreateInput> = z.object({
  ...
  provider: z.string(),
  modelName: z.string(),
  agents: z.lazy(() => AgentUncheckedCreateNestedManyWithoutModelInputSchema).optional()
}).strict();
...
export const ModelUpdateInputSchema: z.ZodType<Prisma.ModelUpdateInput> = z.object({
  ...
  agents: z.lazy(() => AgentUpdateManyWithoutModelNestedInputSchema).optional()
}).strict();
...
export const ModelUncheckedUpdateInputSchema: z.ZodType<Prisma.ModelUncheckedUpdateInput> = z.object({
  ...
  provider: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  modelName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  agents: z.lazy(() => AgentUncheckedUpdateManyWithoutModelNestedInputSchema).optional()
}).strict();
...
export const AgentCreateNestedOneWithoutConversationsInputSchema: z.ZodType<Prisma.AgentCreateNestedOneWithoutConversationsInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedCreateWithoutConversationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AgentCreateOrConnectWithoutConversationsInputSchema).optional(),
...
export const AgentUpdateOneRequiredWithoutConversationsNestedInputSchema: z.ZodType<Prisma.AgentUpdateOneRequiredWithoutConversationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedCreateWithoutConversationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AgentCreateOrConnectWithoutConversationsInputSchema).optional(),
  upsert: z.lazy(() => AgentUpsertWithoutConversationsInputSchema).optional(),
  connect: z.lazy(() => AgentWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => AgentUpdateToOneWithWhereWithoutConversationsInputSchema),z.lazy(() => AgentUpdateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedUpdateWithoutConversationsInputSchema) ]).optional(),
}).strict();
...
export const ConversationCreateNestedManyWithoutAgentInputSchema: z.ZodType<Prisma.ConversationCreateNestedManyWithoutAgentInput> = z.object({
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationCreateWithoutAgentInputSchema).array(),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema),z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ConversationCreateManyAgentInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ModelCreateNestedOneWithoutAgentsInputSchema: z.ZodType<Prisma.ModelCreateNestedOneWithoutAgentsInput> = z.object({
  create: z.union([ z.lazy(() => ModelCreateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedCreateWithoutAgentsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ModelCreateOrConnectWithoutAgentsInputSchema).optional(),
  connect: z.lazy(() => ModelWhereUniqueInputSchema).optional()
}).strict();

export const ConversationUncheckedCreateNestedManyWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUncheckedCreateNestedManyWithoutAgentInput> = z.object({
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationCreateWithoutAgentInputSchema).array(),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema),z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ConversationCreateManyAgentInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
...
export const ConversationUpdateManyWithoutAgentNestedInputSchema: z.ZodType<Prisma.ConversationUpdateManyWithoutAgentNestedInput> = z.object({
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationCreateWithoutAgentInputSchema).array(),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema),z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ConversationUpsertWithWhereUniqueWithoutAgentInputSchema),z.lazy(() => ConversationUpsertWithWhereUniqueWithoutAgentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ConversationCreateManyAgentInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ConversationWhereUniqueInputSchema),z.lazy(() => ConversationWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ConversationUpdateWithWhereUniqueWithoutAgentInputSchema),z.lazy(() => ConversationUpdateWithWhereUniqueWithoutAgentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ConversationUpdateManyWithWhereWithoutAgentInputSchema),z.lazy(() => ConversationUpdateManyWithWhereWithoutAgentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ConversationScalarWhereInputSchema),z.lazy(() => ConversationScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ModelUpdateOneRequiredWithoutAgentsNestedInputSchema: z.ZodType<Prisma.ModelUpdateOneRequiredWithoutAgentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ModelCreateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedCreateWithoutAgentsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ModelCreateOrConnectWithoutAgentsInputSchema).optional(),
  upsert: z.lazy(() => ModelUpsertWithoutAgentsInputSchema).optional(),
  connect: z.lazy(() => ModelWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ModelUpdateToOneWithWhereWithoutAgentsInputSchema),z.lazy(() => ModelUpdateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedUpdateWithoutAgentsInputSchema) ]).optional(),
}).strict();

export const ConversationUncheckedUpdateManyWithoutAgentNestedInputSchema: z.ZodType<Prisma.ConversationUncheckedUpdateManyWithoutAgentNestedInput> = z.object({
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationCreateWithoutAgentInputSchema).array(),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema),z.lazy(() => ConversationCreateOrConnectWithoutAgentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ConversationUpsertWithWhereUniqueWithoutAgentInputSchema),z.lazy(() => ConversationUpsertWithWhereUniqueWithoutAgentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ConversationCreateManyAgentInputEnvelopeSchema).optional(),
...
export const AgentCreateNestedManyWithoutModelInputSchema: z.ZodType<Prisma.AgentCreateNestedManyWithoutModelInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentCreateWithoutModelInputSchema).array(),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema),z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AgentCreateManyModelInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => AgentWhereUniqueInputSchema),z.lazy(() => AgentWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const AgentUncheckedCreateNestedManyWithoutModelInputSchema: z.ZodType<Prisma.AgentUncheckedCreateNestedManyWithoutModelInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentCreateWithoutModelInputSchema).array(),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema),z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AgentCreateManyModelInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => AgentWhereUniqueInputSchema),z.lazy(() => AgentWhereUniqueInputSchema).array() ]).optional(),
...
export const AgentUpdateManyWithoutModelNestedInputSchema: z.ZodType<Prisma.AgentUpdateManyWithoutModelNestedInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentCreateWithoutModelInputSchema).array(),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema),z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => AgentUpsertWithWhereUniqueWithoutModelInputSchema),z.lazy(() => AgentUpsertWithWhereUniqueWithoutModelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AgentCreateManyModelInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => AgentWhereUniqueInputSchema),z.lazy(() => AgentWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => AgentUpdateWithWhereUniqueWithoutModelInputSchema),z.lazy(() => AgentUpdateWithWhereUniqueWithoutModelInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => AgentUpdateManyWithWhereWithoutModelInputSchema),z.lazy(() => AgentUpdateManyWithWhereWithoutModelInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => AgentScalarWhereInputSchema),z.lazy(() => AgentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const AgentUncheckedUpdateManyWithoutModelNestedInputSchema: z.ZodType<Prisma.AgentUncheckedUpdateManyWithoutModelNestedInput> = z.object({
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentCreateWithoutModelInputSchema).array(),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema),z.lazy(() => AgentCreateOrConnectWithoutModelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => AgentUpsertWithWhereUniqueWithoutModelInputSchema),z.lazy(() => AgentUpsertWithWhereUniqueWithoutModelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AgentCreateManyModelInputEnvelopeSchema).optional(),
...
export const AgentCreateWithoutConversationsInputSchema: z.ZodType<Prisma.AgentCreateWithoutConversationsInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  displayName: z.string(),
...
export const AgentUncheckedCreateWithoutConversationsInputSchema: z.ZodType<Prisma.AgentUncheckedCreateWithoutConversationsInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  displayName: z.string(),
...
export const AgentCreateOrConnectWithoutConversationsInputSchema: z.ZodType<Prisma.AgentCreateOrConnectWithoutConversationsInput> = z.object({
  where: z.lazy(() => AgentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => AgentCreateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedCreateWithoutConversationsInputSchema) ]),
}).strict();
...
export const AgentUpsertWithoutConversationsInputSchema: z.ZodType<Prisma.AgentUpsertWithoutConversationsInput> = z.object({
  update: z.union([ z.lazy(() => AgentUpdateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedUpdateWithoutConversationsInputSchema) ]),
  create: z.union([ z.lazy(() => AgentCreateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedCreateWithoutConversationsInputSchema) ]),
  where: z.lazy(() => AgentWhereInputSchema).optional()
}).strict();

export const AgentUpdateToOneWithWhereWithoutConversationsInputSchema: z.ZodType<Prisma.AgentUpdateToOneWithWhereWithoutConversationsInput> = z.object({
  where: z.lazy(() => AgentWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => AgentUpdateWithoutConversationsInputSchema),z.lazy(() => AgentUncheckedUpdateWithoutConversationsInputSchema) ]),
}).strict();

export const AgentUpdateWithoutConversationsInputSchema: z.ZodType<Prisma.AgentUpdateWithoutConversationsInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  displayName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AgentUncheckedUpdateWithoutConversationsInputSchema: z.ZodType<Prisma.AgentUncheckedUpdateWithoutConversationsInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  displayName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ConversationCreateOrConnectWithoutAgentInputSchema: z.ZodType<Prisma.ConversationCreateOrConnectWithoutAgentInput> = z.object({
  where: z.lazy(() => ConversationWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema) ]),
}).strict();

export const ConversationCreateManyAgentInputEnvelopeSchema: z.ZodType<Prisma.ConversationCreateManyAgentInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ConversationCreateManyAgentInputSchema),z.lazy(() => ConversationCreateManyAgentInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ModelCreateWithoutAgentsInputSchema: z.ZodType<Prisma.ModelCreateWithoutAgentsInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  provider: z.string(),
...
export const ModelUncheckedCreateWithoutAgentsInputSchema: z.ZodType<Prisma.ModelUncheckedCreateWithoutAgentsInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  provider: z.string(),
...
export const ModelCreateOrConnectWithoutAgentsInputSchema: z.ZodType<Prisma.ModelCreateOrConnectWithoutAgentsInput> = z.object({
  where: z.lazy(() => ModelWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ModelCreateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedCreateWithoutAgentsInputSchema) ]),
}).strict();

export const ConversationUpsertWithWhereUniqueWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUpsertWithWhereUniqueWithoutAgentInput> = z.object({
  where: z.lazy(() => ConversationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ConversationUpdateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedUpdateWithoutAgentInputSchema) ]),
  create: z.union([ z.lazy(() => ConversationCreateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedCreateWithoutAgentInputSchema) ]),
}).strict();

export const ConversationUpdateWithWhereUniqueWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUpdateWithWhereUniqueWithoutAgentInput> = z.object({
  where: z.lazy(() => ConversationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ConversationUpdateWithoutAgentInputSchema),z.lazy(() => ConversationUncheckedUpdateWithoutAgentInputSchema) ]),
}).strict();

export const ConversationUpdateManyWithWhereWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUpdateManyWithWhereWithoutAgentInput> = z.object({
  where: z.lazy(() => ConversationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ConversationUpdateManyMutationInputSchema),z.lazy(() => ConversationUncheckedUpdateManyWithoutAgentInputSchema) ]),
}).strict();

export const ModelUpsertWithoutAgentsInputSchema: z.ZodType<Prisma.ModelUpsertWithoutAgentsInput> = z.object({
  update: z.union([ z.lazy(() => ModelUpdateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedUpdateWithoutAgentsInputSchema) ]),
  create: z.union([ z.lazy(() => ModelCreateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedCreateWithoutAgentsInputSchema) ]),
  where: z.lazy(() => ModelWhereInputSchema).optional()
}).strict();

export const ModelUpdateToOneWithWhereWithoutAgentsInputSchema: z.ZodType<Prisma.ModelUpdateToOneWithWhereWithoutAgentsInput> = z.object({
  where: z.lazy(() => ModelWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ModelUpdateWithoutAgentsInputSchema),z.lazy(() => ModelUncheckedUpdateWithoutAgentsInputSchema) ]),
}).strict();

export const ModelUpdateWithoutAgentsInputSchema: z.ZodType<Prisma.ModelUpdateWithoutAgentsInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  provider: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ModelUncheckedUpdateWithoutAgentsInputSchema: z.ZodType<Prisma.ModelUncheckedUpdateWithoutAgentsInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  provider: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AgentCreateWithoutModelInputSchema: z.ZodType<Prisma.AgentCreateWithoutModelInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  displayName: z.string(),
...
export const AgentUncheckedCreateWithoutModelInputSchema: z.ZodType<Prisma.AgentUncheckedCreateWithoutModelInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  displayName: z.string(),
...
export const AgentCreateOrConnectWithoutModelInputSchema: z.ZodType<Prisma.AgentCreateOrConnectWithoutModelInput> = z.object({
  where: z.lazy(() => AgentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema) ]),
}).strict();

export const AgentCreateManyModelInputEnvelopeSchema: z.ZodType<Prisma.AgentCreateManyModelInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => AgentCreateManyModelInputSchema),z.lazy(() => AgentCreateManyModelInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const AgentUpsertWithWhereUniqueWithoutModelInputSchema: z.ZodType<Prisma.AgentUpsertWithWhereUniqueWithoutModelInput> = z.object({
  where: z.lazy(() => AgentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => AgentUpdateWithoutModelInputSchema),z.lazy(() => AgentUncheckedUpdateWithoutModelInputSchema) ]),
  create: z.union([ z.lazy(() => AgentCreateWithoutModelInputSchema),z.lazy(() => AgentUncheckedCreateWithoutModelInputSchema) ]),
}).strict();

export const AgentUpdateWithWhereUniqueWithoutModelInputSchema: z.ZodType<Prisma.AgentUpdateWithWhereUniqueWithoutModelInput> = z.object({
  where: z.lazy(() => AgentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => AgentUpdateWithoutModelInputSchema),z.lazy(() => AgentUncheckedUpdateWithoutModelInputSchema) ]),
}).strict();

export const AgentUpdateManyWithWhereWithoutModelInputSchema: z.ZodType<Prisma.AgentUpdateManyWithWhereWithoutModelInput> = z.object({
  where: z.lazy(() => AgentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => AgentUpdateManyMutationInputSchema),z.lazy(() => AgentUncheckedUpdateManyWithoutModelInputSchema) ]),
}).strict();
...
export const ConversationUncheckedUpdateWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUncheckedUpdateWithoutAgentInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lastMessageAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ConversationUncheckedUpdateManyWithoutAgentInputSchema: z.ZodType<Prisma.ConversationUncheckedUpdateManyWithoutAgentInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  lastMessageAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AgentCreateManyModelInputSchema: z.ZodType<Prisma.AgentCreateManyModelInput> = z.object({
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  displayName: z.string(),
...
export const AgentUpdateWithoutModelInputSchema: z.ZodType<Prisma.AgentUpdateWithoutModelInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  displayName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AgentUncheckedUpdateWithoutModelInputSchema: z.ZodType<Prisma.AgentUncheckedUpdateWithoutModelInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  displayName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AgentUncheckedUpdateManyWithoutModelInputSchema: z.ZodType<Prisma.AgentUncheckedUpdateManyWithoutModelInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  displayName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ModelFindFirstArgsSchema: z.ZodType<Prisma.ModelFindFirstArgs> = z.object({
  ...
  include: ModelIncludeSchema.optional(),
...
export const ModelUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.ModelUpdateManyAndReturnArgs> = z.object({
  data: z.union([ ModelUpdateManyMutationInputSchema,ModelUncheckedUpdateManyInputSchema ]),
  where: ModelWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;
...
export const MemoryUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.MemoryUpdateManyAndReturnArgs> = z.object({
  data: z.union([ MemoryUpdateManyMutationInputSchema,MemoryUncheckedUpdateManyInputSchema ]),
  where: MemoryWhereInputSchema.optional(),
  limit: z.number().optional(),
}).strict() ;
